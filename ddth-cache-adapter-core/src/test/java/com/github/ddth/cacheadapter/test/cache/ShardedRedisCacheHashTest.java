 ...
 * @since 0.6.2
 */
public class ShardedRedisCacheHashTest extends BaseShardedRedisCacheTest {

    public ShardedRedisCacheHashTest(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(ShardedRedisCacheHashTest.class);
    }
