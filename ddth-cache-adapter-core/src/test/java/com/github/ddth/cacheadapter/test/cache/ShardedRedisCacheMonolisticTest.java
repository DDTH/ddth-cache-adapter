 ...
 * @since 0.6.2
 */
public class ShardedRedisCacheMonolisticTest extends BaseShardedRedisCacheTest {

    public ShardedRedisCacheMonolisticTest(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(ShardedRedisCacheMonolisticTest.class);
    }
